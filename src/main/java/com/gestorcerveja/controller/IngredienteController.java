...
public class IngredienteController {
    ...
    public List<Ingrediente> listAll() throws SQLException {
        return service.getAll();
    }

    public List<Ingrediente> listLowStock() throws SQLException {
        return service.getLowStock();
    }

    public void create(String nome, String unidade,
                       double stockAtual, double stockMinimo) throws SQLException {
