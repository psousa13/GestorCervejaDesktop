...
public class LoteService {
    ...
    public LoteService(LoteRepository repo, VeiculoService veiculoService) { this.repo=repo; this.veiculoService=veiculoService; }
    ...
    public int create(int idpedido, int idreceita, double litros, LocalDate data, int idveiculo, int idrequest) { if(litros<=0) throw new IllegalArgumentException("Litros deve ser positivo."); veiculoService.addCarga(idveiculo,litros); return repo.insert(new Lote(0,idpedido,idreceita,litros,data,idveiculo,idrequest)); }
