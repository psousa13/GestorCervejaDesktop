...
public class IngredienteService {
    ...
    public List<Ingrediente> getAll()      throws SQLException { return repo.findAll(); }
    public List<Ingrediente> getLowStock() throws SQLException { return repo.findBelowMinStock(); }

    public Ingrediente getById(int id) throws SQLException {
        Ingrediente i = repo.findById(id);
        if (i == null) throw new IllegalArgumentException("Ingrediente " + id + " não encontrado.");
        return i;
    }
